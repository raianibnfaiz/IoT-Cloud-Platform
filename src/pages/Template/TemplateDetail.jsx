    ...
    return (
        <div className={`min-h-screen ${darkMode ? "dark" : ""}`}>
            <div className="min-h-screen bg-slate-50 dark:bg-slate-900 transition-colors duration-200">
                {/* Top Navigation Bar */}
                <nav className="bg-white dark:bg-slate-800 shadow-sm border-b border-slate-200 dark:border-slate-700 transition-colors duration-200 fixed top-0 left-0 right-0 z-20">
                ...
                <div className="flex">
                    <div
                        className={`${sidebarCollapsed ? "w-16" : "w-64"
                            } min-h-screen bg-slate-800 text-white transition-all duration-300 fixed left-0 top-16 z-10 h-full overflow-y-auto`}
                    >
                        <div className="p-4">
