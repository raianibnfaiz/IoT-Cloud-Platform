                ...
                <div className="min-h-screen bg-gradient-to-b from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800">
                    ...
                    <div className="pt-20 pb-16 text-center">
                        ...
                        <div className="flex items-center justify-center mb-12">
                            ...
                            >
                                <div
                                    className={`bg-white w-6 h-6 rounded-full shadow-md transform transition-transform duration-300 ${isAnnual ? 'translate-x-8' : ''
                                        }`}
                                />
                            </button>
                            <span className={`text-sm ${isAnnual ? 'text-slate-900 dark:text-white' : 'text-slate-500 dark:text-slate-400'}`}>
                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-24">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                            {plans.map((plan) => (
                                <div
                                    key={plan.name}
                                    className={`relative rounded-2xl bg-white dark:bg-slate-800 shadow-xl ${plan.highlighted ? 'ring-2 ring-emerald-500' : ''
                                        }`}
                                >
                                    {plan.highlighted && (
                                    ...
                                    <div className="p-8">
                                        ...
                                        <Link
                                            to={plan.buttonLink}
                                            className={`block w-full py-3 px-6 text-center rounded-lg text-white font-semibold transition-all duration-200 ${plan.highlighted
